...
uploadImage(image:File){
  ...
  const imageData = new FormData();
   ...
   this.http.post<{message:string,imageID:string,imagePath:string}>("http://3.15.155.27:1035/home/uploadImage",imageData).subscribe(responseData =>{
...
updateImage(imageID:string,image:File){
  ...
  imageData.append("image",image);
  this.http.put("http://3.15.155.27:1035/home/imageUpdate",imageData).subscribe(responseData =>{
...
deleteImage(imageID:string){
  this.http.delete("http://3.15.155.27:1035/home/"+ imageID).subscribe(()=>{
...
getImagepath(){
  this.http.get("http://3.15.155.27:1035/home/imagePath").subscribe(ImageData =>{
...
/*FUNCTION TO ADD HOME DATA TO DATABASE */
  ...
  /*addInfo(homeInfo:string){
   ...
   this.http.post<{message:string;dataID:string}>("http://3.15.155.27:1035/home/info",homeDetails).subscribe(responseData => {
  ...
  getInfo(){
    this.http.get("http://3.15.155.27:1035/home/info").subscribe(responseData =>{
  ...
  updateHomeInfo(id:string,data:string){
    ...
    this.http.put("http://3.15.155.27:1035/home/update",homeDetails).subscribe(responseData =>{
 ...
 addWhyUsInfo(qualityInfo:string,innovationInfo:string,facilityInfo:string,locationInfo:string){
  ...
  this.http.post<{message:string;dataID:string}>("http://3.15.155.27:1035/home/whyus",whyusDetails).subscribe(responseData => {
    console.log(responseData);
 ...
 getWhyIUsInfo(){
  this.http.get("http://3.15.155.27:1035/home/whyus").subscribe(responseData =>{
  ...
  updateWhyusQualityInfo(id:string,qualityInfo:string){
    ...
    this.http.put("http://3.15.155.27:1035/home/update-quality",whyusQualityInfo).subscribe(responseData =>{
    ...
    updateWhyusInnovationInfo(id:string,innovationInfo:string){
      ...
      this.http.put("http://3.15.155.27:1035/home/update-innovation",whyusInnovationInfo).subscribe(responseData =>{
          if(responseData["status"]=="success")
          {
            var whyusQualityInfoResponse:whyUsInfo = responseData["data"];
            alert("Information Updated Successfully");
       ...
       updateWhyusFacilityInfo(id:string,facilityInfo:string){
        ...
        this.http.put("http://3.15.155.27:1035/home/update-facility",whyusFacilitynInfo).subscribe(responseData =>{
            if(responseData["status"]=="success")
            {
             ...
             updateWhyusLocationInfo(id:string,locationInfo:string){
              ...
              this.http.put("http://3.15.155.27:1035/home/update-location",whyusLocationInfo).subscribe(responseData =>{
                  if(responseData["status"]=="success")
                  {
