...
export class ContactLocationService {
  ...
  addLocation(location1:string,location2:string,location3:string,location4:string)
  {
   ...
   this.http.post<{message:string;locationId:string}>("http://3.15.155.27:1035/location/info",location).subscribe(responseData => {
  ...
  getLocation(){
    this.http.get<{message:string,data:any}>("http://3.15.155.27:1035/location/info"
  ...
  updateLocation(id:string,location1:string,location2:string,location3:string,location4:string){
    ...
    this.http.put("http://3.15.155.27:1035/location/update",location).subscribe(responseData =>{
  ...
  deleteLocation(locationID:string){
    this.http.delete("http://3.15.155.27:1035/location/" + locationID)
    .subscribe(() => {
